...
#my ip used to secure the access to the vm
data "http" "myip" {
...
resource "azurerm_network_security_group" "my_terraform_nsg" {
  name                =  "${var.name_prefix}-NetworkSecurityGroup"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name
...
resource "azurerm_linux_virtual_machine" "my_terraform_vm" {
  ...
  #available images can be found with the command below:
  ...
  disable_password_authentication = true
   ...
   # troubleshoot can de made by looking to /var/log/cloud-init.log on the VM
